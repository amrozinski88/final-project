...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as New Buddy"} primary={true} style={style} onClick={(event) => this.handleClick(event,'student')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as Budget Pro "} primary={true} style={style} onClick={(event) => this.handleClick(event,'teacher')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      budgetbuttonLabel:'Register as New Buddy',
      teacherbuttonLabel:'Register as Budget Pro',
      isLogin:true
    }
  }
  componentWillMount(){
  ...
  handleClick(event,userRole){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
          <div>
             <RaisedButton label={"Register as New Buddy"} primary={true} style={style} onClick={(event) => this.handleClick(event,'buddy')}/>
         </div>
         </MuiThemeProvider>
         <MuiThemeProvider>
         <div>
